...
import { Search, Plus, ArrowRight, Delete, Back, Key } from '@element-plus/icons-vue'; // 【修改】加入 Key icon
...
import { useRouter } from 'vue-router'; // 【修改】加入 useRouter



const router = useRouter(); // 【修改】初始化 Router
...
mainkeys: MainKey[]; // 【修改】加入 mainkeys 定義
...
const newProjectForm = reactive({ projectname: '', codename: '' }); // 【修改】移除 mainKey，因採用獨立綁定頁面
